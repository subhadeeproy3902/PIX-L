      ...
      <form className="mt-10 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className="mt-5 flex gap-5">
          <button
            ...
            className="mx-auto text-white hover:bg-green-700 duration-200 ease-in-out bg-green-600 font-medium rounded-md text-sm w-64 px-5 py-2.5 text-center"
          >
            {generatingImg ? 'Generating...' : 'Generate'}
          </button>
        </div>

        <div className="mt-10 text-neutral px-4 w-full flex flex-col">
          <p className="mt-2 text-[#666e75] text-[14px]">** Once you have created the image you want, you can share it with others in the community **</p>
          <button
            type="submit"
            className="mt-3 mx-auto text-white bg-purple-500 hover:bg-purple-600 duration-200 ease-in-out font-medium rounded-md text-sm w-64 px-5 py-2.5 text-center"
          >
